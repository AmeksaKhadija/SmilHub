                    ...
                    <td>
                        <div class="content-actions-cell">
                            ...
                            <form action="{{ route('contents.destroy', $content->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="content-action delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet article?')">
                ...
                <tr>
                    <td colspan="6">
                        <div class="empty-state">
                            ...
                            <p class="empty-state-description">Vous n'avez pas encore créé de contenu. Commencez par créer votre premier article!</p>
                            <a href="{{ route('contents.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Créer un nouvel article
                            </a>
                        </div>
