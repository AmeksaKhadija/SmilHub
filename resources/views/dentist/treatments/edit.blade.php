...
@section('treatment')
    <div class="content-header">
        <h1 class="content-title">Modifier le Treatment</h1>
        ...
        <form action="{{ route('treatment.update', $treatment->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="description" name="description" class="form-control"
                    value="{{ old('description', $treatment->description) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea id="medications" name="medications" class="form-control form-textarea" required>{{ old('medications', $treatment->medications) }}</textarea>
