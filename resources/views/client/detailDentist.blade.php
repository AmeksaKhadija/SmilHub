            ...
            <div class="profile-container">
                ...
                <div class="dentist-profile-card">
                    <img src="/{{ $dentist->user->image }}" alt="Dr. {{ $dentist->user->nom }} {{ $dentist->user->prenom }}"
                        class="dentist-avatar-large">
                    <h2 class="dentist-name-large">Dr. {{ $dentist->user->nom }} {{ $dentist->user->prenom }}</h2>
                    <span class="dentist-specialty-large">{{ $dentist->speciality }}</span>
                    ...
                    <p class="dentist-bio">
                        {{ $dentist->bio ?? 'Dr. ' . $dentist->user->nom . ' ' . $dentist->user->prenom . ' est un dentiste expérimenté spécialisé dans ' . $dentist->speciality . '. Avec plusieurs années d\'expérience, il/elle s\'engage à fournir des soins dentaires de qualité dans un environnement confortable et accueillant.' }}
                    </p>
                ...
                <div class="content-section">
                    <div class="content-header">
                        ...
                        <p>Découvrez les articles éducatifs et conseils de santé dentaire rédigés par Dr.
                            {{ $dentist->user->nom }} {{ $dentist->user->prenom }}.</p>
                    </div>
                    ...
                    <div class="content-grid">
                        @forelse($contents as $content)
                            <div class="content-card" data-category="{{ $content->category_id }}">
                                ...
                                <div class="content-card-body">
                                    ...
                                    <p class="content-card-excerpt">{{ Str::limit(strip_tags($content->content), 120) }}
                                    </p>
                                    <div class="content-card-footer">
                                        <span class="content-card-date">{{ $content->created_at->format('d M Y') }}</span>
                                        <a href="{{ route('detailContent', $content->id) }}" class="read-more">Lire plus
                        ...
                        @empty
                            <div class="no-content">
                                ...
                                <p>Dr. {{ $dentist->user->nom }} {{ $dentist->user->prenom }} n'a pas encore publié
                                    d'articles ou de ressources.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
